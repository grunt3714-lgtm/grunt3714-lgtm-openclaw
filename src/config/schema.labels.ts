...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "channels.discord.voice.silenceDurationMs": "Discord Voice Silence Duration (ms)",
  "channels.discord.voice.minSegmentSeconds": "Discord Voice Minimum Segment Seconds",
